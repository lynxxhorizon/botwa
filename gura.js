...
${mot} _$ exec_
`
gura.sendMessage(from, { contentText: `${menuh}`, footerText: `©𝘉𝘰𝘵 𝘞𝘩𝘢𝘵𝘴𝘈𝘱𝘱`, buttons: [{ buttonId: `${prefix}owner`, buttonText: { displayText: '𝘖𝘸𝘯𝘦𝘳 𝘉𝘰𝘵 メ' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: tamnel, contextInfo: {mentionedJid: [sender, ownerNumber]}}}, 'buttonsMessage')
break
